...
export const PlanetInformation = [
	{
		...
		planetImg: [
			...
			'planets-data/assets/planet-mercury-internal.svg',
			'planets-data/assets/planet-mercury.svg',
			'planets-data/assets/geology-mercury.png'
		],
		planetDescription:
	...
	},
	{
		...
		planetName: 'VENUS',
		planetImg: [
			'planets-data/assets/planet-venus.svg',
			'planets-data/assets/planet-venus-internal.svg',
			'planets-data/assets/planet-venus.svg',
			'planets-data/assets/geology-venus.png'
		],
		planetDescription:
	...
	},
	{
		...
		planetName: 'EARTH',
		planetImg: [
			'planets-data/assets/planet-earth.svg',
			'planets-data/assets/planet-earth-internal.svg',
			'planets-data/assets/planet-earth.svg',
			'planets-data/assets/geology-earth.png'
		],
		planetDescription:
	...
	},
	{
		...
		planetName: 'MARS',
		planetImg: [
			'planets-data/assets/planet-mars.svg',
			'planets-data/assets/planet-mars-internal.svg',
			'planets-data/assets/planet-mars.svg',
			'planets-data/assets/geology-mars.png'
		],
		planetDescription:
	...
	},
	{
		...
		planetName: 'JUPITER',
		planetImg: [
			'planets-data/assets/planet-jupiter.svg',
			'planets-data/assets/planet-jupiter-internal.svg',
			'planets-data/assets/planet-jupiter.svg',
			'planets-data/assets/geology-jupiter.png'
		],
		planetDescription:
	...
	},
	{
		...
		planetName: 'SATURN',
		planetImg: [
			'planets-data/assets/planet-saturn.svg',
			'planets-data/assets/planet-saturn-internal.svg',
			'planets-data/assets/planet-saturn.svg',
			'planets-data/assets/geology-saturn.png'
		],
		planetDescription:
	...
	},
	{
		...
		planetName: 'URANUS',
		planetImg: [
			'planets-data/assets/planet-uranus.svg',
			'planets-data/assets/planet-uranus-internal.svg',
			'planets-data/assets/planet-uranus.svg',
			'planets-data/assets/geology-uranus.png'
		],
		planetDescription:
	...
	},
	{
		...
		planetName: 'NEPTUN',
		planetImg: [
			'planets-data/assets/planet-neptune.svg',
			'planets-data/assets/planet-neptune-internal.svg',
			'planets-data/assets/planet-neptune.svg',
			'planets-data/assets/geology-neptune.png'
		],
		planetDescription:
